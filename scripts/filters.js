...
function displayItemsInFilter (item, importContainer, allTagsContainer) {
...
function filterAppliancesFromInput () {
  ...
  applianceFilterInput.addEventListener('input', (event) => {
    ...
    items.forEach((item) => { 
      item.addEventListener("click", function() {                   // permet de supprimer le texte dans la barre de recherche 
        event.target.value = "";   
...
function filterUstensilesFromInput () {
